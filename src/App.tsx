...
export default function App() {
  ...
  const [entryScreen, setEntryScreen] = useState<"welcome" | "auth" | "tour" | "new">("welcome");
...
SUMMARY:${block.title}
DESCRIPTION:Quarterly Plan Block
UID:${block.id}@quarterly-planner
END:VEVENT
`;
      });
    });
    ...
    a.href = url;
    a.download = `quarterly-${toIsoDate(new Date())}.ics`;
    a.click();
